...
exports.getFeatures = (project, token) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const respose = yield axios_1.default.get(`https://api.optimizely.com/v2/features?project_id=${project}&per_page=99`, {
        headers: {
    ...
    throw new Error((_b = (_a = respose.data) === null || _a === void 0 ? void 0 : _a.message) !== null && _b !== void 0 ? _b : 'uh oh');
});
